                ...
                <nav class="h-full px-2 py-4 space-y-1 overflow-y-auto scrollbar-thin scrollbar-track-gray-800 scrollbar-thumb-gray-600 hover:scrollbar-thumb-gray-500" style="scroll-behavior: smooth;">
                    ...
                    <a href="{{ route('admin.email-settings.index') }}" 
                       class="group flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.email-settings.*') ? 'bg-coral text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                        <i class="bi bi-envelope-gear mr-3 text-lg"></i>
                    ...
                    <a href="{{ route('admin.contact-info.index') }}" 
                       class="group flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.contact-info.*') ? 'bg-coral text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
...
// CORRECTION CRITIQUE - Nettoyage timeout commenté pour éviter conflit TinyMCE
// window.addEventListener("beforeunload", function() {
//     // ❌ PROBLÈME : Ce code détruit les timeouts de TinyMCE !
//     // Nettoyer tous les timeouts/intervals
